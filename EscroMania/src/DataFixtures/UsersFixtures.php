...
class UsersFixtures extends Fixture
{
    ...
    {
        $admin =new Users();
        $admin->setEmail('florianfemery1@gmail.com');
        $admin->setLastname('ADMIN');
        $admin->setFirstname('Afpa');
        $admin->setAddresse('69 rue du Finister');
        $admin->setZipcode('80080');
        ...
        for($usr = 1; $usr <= 5; $usr++){
            ...
            $user->setAddresse($faker->streetAddress);

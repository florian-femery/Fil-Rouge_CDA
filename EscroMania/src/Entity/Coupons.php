...
class Coupons
{
    ...
    private ?string $descriptioncoup = null;
    ...
    public function getDescriptioncoup(): ?string
    {
        return $this->descriptioncoup;
    }

    public function setDescriptioncoup(string $descriptioncoup): static
    {
        $this->descriptioncoup = $descriptioncoup;
